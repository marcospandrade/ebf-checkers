...
public class NeuralNetwork2L extends FeedForwardNN {
	public NeuralNetwork2L() {
		...
		layer2[0] = new SigmoidPerceptron(layer1[0], layer1[1], layer1[4],
				layer1[5], layer1[8], layer1[9], layer1[12], layer1[13]);
		layer2[1] = new SigmoidPerceptron(layer1[2], layer1[3], layer1[6],
				layer1[7], layer1[10], layer1[11], layer1[14], layer1[15]);
		layer2[2] = new SigmoidPerceptron(layer1[16], layer1[17], layer1[20],
				layer1[21], layer1[24], layer1[25], layer1[28], layer1[29]);
		layer2[3] = new SigmoidPerceptron(layer1[18], layer1[19], layer1[22],
				layer1[23], layer1[26], layer1[27], layer1[30], layer1[31]);
