...
public class NeuralNetwork1L extends FeedForwardNN {
	public NeuralNetwork1L() {
		super(32);
		...
		// Output Layer
		output = new SigmoidPerceptron(layer1);
		for (int i = 0; i < output.getNumInputs(); i++)
			output.setWeight(i, 0.4f);
	}
}
